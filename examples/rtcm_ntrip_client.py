...
def main(**kwargs):
    ...
    server = kwargs.get("server", "192.168.60.42")
    mountpoint = kwargs.get("mountpoint", "beken")
    user = kwargs.get("user", getenv("PYGPSCLIENT_USER", "beken"))
    password = kwargs.get("password", getenv("PYGPSCLIENT_PASSWORD", "beken"))
